// Package initinterp interprets Go package initializers as much as possible.
// This avoid running them at runtime, improving code size and making other
...
func (e *Eval) Function(fn llvm.Value, params []Value, pkgName string) (Value, error) {
	...
	for {
		retval, outgoing, err := fr.evalBasicBlock(bb, lastBB)
		if outgoing == nil {
